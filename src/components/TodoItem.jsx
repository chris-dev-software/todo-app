  ...
  return (
    <li className='bg-neutral-100 p-2 rounded-md shadow-md'>
      ...
      <footer className='grid grid-cols-2 gap-5'>
        <button onClick={() => changeCompleteTask(id)} className='text-white bg-green-500 hover:bg-green-600 transition-colors px-2 py-1 rounded-lg'>
          {completed ? 'Incomplete' : 'Complete'}
        </button>
        <button onClick={() => deleteTodo(id)} className='text-white bg-red-500 hover:bg-red-600 transition-colors px-2 py-1 rounded-lg'>
          Delete
        </button>
      </footer>
    </li>
